...
if("TRUE" STREQUAL "TRUE")
  set(UI_SOURCE_PREFIX /home/qiyi/Documents/okd/catkin_ws/src/UI)
  set(UI_DEVEL_PREFIX /home/qiyi/Documents/okd/catkin_ws/devel)
  set(UI_INSTALL_PREFIX "")
  set(UI_PREFIX ${UI_DEVEL_PREFIX})
else()
  set(UI_SOURCE_PREFIX "")
  set(UI_DEVEL_PREFIX "")
  set(UI_INSTALL_PREFIX /home/qiyi/Documents/okd/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'qiyi <qiyi@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'UI' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qiyi/Documents/okd/catkin_ws/src/UI/${idir}'.  ${_report}")
    endif()
